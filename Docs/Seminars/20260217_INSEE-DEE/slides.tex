...
$\rightarrow$ Complementarity of spatial analysis (Moran and GWR) and econometrics methods (Multi-level regression), and a minimal theoretical model.
...
$\rightarrow$ \textbf{Complementary approaches} and conclusions through GWR and multi-level modeling
