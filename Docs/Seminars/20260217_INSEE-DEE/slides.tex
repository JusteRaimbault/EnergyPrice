...
\date[17/02/2026]{S{\'e}minaire INSEE - DEE, 17/02/2026}
\author[Raimbault and Bergeaud]{J. Raimbault$^{1}$ and A. Bergeaud$^{2}$\\
...
\textbf{Diverse approaches in the litterature:}
...
\includegraphics[width=\textwidth]{../../Communication/figures/average_regular_map}
...
\textbf{1. Heterogeneous Spatial Performance}
    ...
    \begin{itemize}
        \item \textbf{Optimal Bandwidth:} Log-normal distribution of process scales.
        \item \textbf{Metrics:} Median distance of \textbf{77 km} (IQR: 30 km).
        \item \textbf{Interpretation:} Defines the range of \textbf{coherent market competition} and the spatial stationarity of price-setting processes.
    \end{itemize}
